        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex gap-8 mb-12 overflow-x-auto pb-4">
            {steps.map((step, index) => (
              ...
              >
                <div className="text-sm uppercase tracking-wider mb-1">{step.phase}</div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="aspect-square bg-black border border-white/10 rounded-lg p-8">
...
const CommunicationVisual = () => (
  <div className="relative w-full h-full flex items-center justify-center">
    <div className="text-center">
      ...
      <motion.div
        className="h-16 border-l border-white/20 mx-auto"
        initial={{ scaleY: 0 }}
        animate={{ scaleY: 1 }}
      ...
      >
        <div className="text-sm text-white/40">Decomposed into:</div>
        <div className="text-xs text-white/30">• Analyze resource availability</div>
        <div className="text-xs text-white/30">• Compare pricing across nodes</div>
        <div className="text-xs text-white/30">• Allocate optimal configuration</div>
      </motion.div>
    </div>
  </div>
);
  ...
  <div className="relative w-full h-full flex items-center justify-center">
    <div className="relative">
      ...
      <motion.div
        ...
        transition={{ duration: 0.5 }}
      >
        <div className="text-white/60">ZK</div>
      </motion.div>
      {/* Proof rings */}
      {[1, 2, 3].map((i) => (
        <motion.div
    ...
    <div className="space-y-4">
      {[0, 1, 2].map((i) => (
        ...
        >
          ...
          <div className={`w-${20 + i * 10} h-1 bg-white/40`} />
        </motion.div>
      ))}
      <motion.div
