...
const PRIVACY_NETWORK_PUBLIC_STATS_ENDPOINT = `${API_BASE_URL}/privacy_network/vpn/public/network-stats/`;
...
export const fetchVpnNetworkStats = async () => {
  try {
    const response = await fetch(PRIVACY_NETWORK_PUBLIC_STATS_ENDPOINT);
    if (!response.ok) {
